        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <svg viewBox="0 0 400 400" className="w-full max-w-md mx-auto">
              ...
              <text x="200" y="60" textAnchor="middle" className="text-xs fill-emerald-700">$45B</text>
              ...
              <text x="200" y="210" textAnchor="middle" className="text-xs fill-white">$500M</text>
